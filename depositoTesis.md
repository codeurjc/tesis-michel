...
```mermaid
graph TD
A[Depósito de la Tesis Doctoral por Registro]-->B[Revisión por comisión académica del programa]
B --Genera informe-->C[15 días de espera para que otro doctor pueda evaluarla]
C--Cualquiera podría emitir delegaciones-->CD[Comité de dirección]
CD--Aprobación o Denegación-->D[Avisar 15 días NATURALES antes fecha defensa]
D--Confirmación-->E[Defensa]
A--30 días mínimo!!-->E
```
