...
Buildability of software projects is fundamental to be able to execute tests. %Following are the works that address this property of the projects:
...
\michel{Grex: Add cite: \cite{iannone2021toward}}
