...
\patxi{Mójate, y di cuál de los puntos anteriores parece pertenecer a una categoría u otra.}
\michel{To discuss: En principio, la diferenciación ya está hecha (fijate en lso títulos de los puntos anteriores)}
...
\patxi{Di que esto se mitiga con el case study que nos permite añadir algunas métricas más precisamente porque vemos que las iniciales no parecen representar todos los casos de manera adecuada.}\michel{Done}
