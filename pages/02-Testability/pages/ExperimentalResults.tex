...
The remaining 17 projects correspond to projects that contain multiple maven modules and cannot be built and tested with the proposed methodology. \patxi{Ojo con esto que nos pueden decir que lo arreglemos, que un proyecto maven multimodulo no es nada raro}
...
\begin{table}[h]
    ...
    \caption{Mean ($\mean{x}$) and Median ($\median{x}$) values for Buildability and Testability of the projects.}
        ...
        \begin{tabular}{|r|r|r|}
            ...
            \textbf{Fully Testability\textsubscript{T}\patxi{Este es A, no?}}          & 22.12\%                              & 14.88\%                                \\ \hline
...
The division of projects into the three categories (long, medium and short) is based on the number of commits.\patxi{Primero di que los agrupas por número de commits, y luego explicas lo de las barras. SI no queda raro}
It is easy to appreciate, just by checking colors, how each project tells a very different story. 

\begin{figure}[h!]
    \centering    
    \includegraphics[width=0.7\textwidth]{pages/02-Testability/images/Many4j 1-22.pdf}
    \caption{Project metrics (Large projects)}
    \label{fig:many4j-1-bar-chart}
\end{figure}%
\begin{figure}[h!]
    \centering    
    \includegraphics[width=0.7\textwidth]{pages/02-Testability/images/Many4j 23-44.pdf}
    \caption{Project metrics (Medium projects)}
    \label{fig:many4j-2-bar-chart}
\end{figure} 
\begin{figure}[h!]
    \centering    
    \includegraphics[width=0.7\textwidth]{pages/02-Testability/images/Many4j 45-66.pdf}
