...
%     \patxi{over all projects?}
%     \michel{To discuss: Es de los 66 proyectos, después del filtrado de los que no tienen tests, no tengo claro como adelantar estos resultados, quizás haya que mover esta gráfica más adelante.}}
%     \michel{Añadir una aclaración del filtrado de los proyectos que no tienen tests (the number of commits analyzed in each step can be seen in Figure~\ref{fig:methodology-process})}
