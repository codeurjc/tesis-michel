...
\begin{table*}[h!]
    ...
    \caption{Extended metrics of set of projects 3: Zxing, Okio and Closure (including the new Testability Rate\textsubscript{T} and Fully Testability\textsubscript{T} metrics)}\patxi{Los datos de esta tabla quedan muy pequeños. Se pueden poner las cabeceras en diagonal para ahorrar espacio y que los números puedan ser más grandes}\michel{TODO}
