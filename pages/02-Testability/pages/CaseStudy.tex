...
Its low Fully Testability value is due to a few tests fail\patxi{failing consistently (in the order of 10 out of 1000)?}\michel{To discuss: Como en la figura se muestra la cantidad de test verdes/rojos que hay, se puede apreciar que en la mayoria de commits el \% es muy bajo, menos de 10 por cada 1000} along the project history.
