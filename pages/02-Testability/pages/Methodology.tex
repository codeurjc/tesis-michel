...
\begin{figure}[h!]
    ...
    \caption{Study overview \patxi{over all projects?}\michel{Es de los 66 proyectos, después del filtrado de los que no tienen tests, no tengo claro como adelantar estos resultados, quizás haya que mover esta gráfica más adelante.}}
