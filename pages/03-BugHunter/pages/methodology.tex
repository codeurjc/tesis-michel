...
\michel{To discuss: Seguimos considerando una única rama (master). La cuestión es que al recorrer máster, enconramos que los commits que llegan a esta rama vienen de otra.}
...
\item \textbf{The test does not succeed in any precedent commit.}
  ...
  \michel{To discuss: Yo los distingui (hablabamos de commits grises o negros), pero se acordo (no por mi parte) que los trataramos igual. Se habla largo y tendido de estos casos en la discussion}
\end{itemize}
