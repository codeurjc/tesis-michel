...
\michel{To discuss: Los autores detectan esos bugs habiendo buscado en todos los proyectos del dataset (como nosotros). Lo que pasa es que ellos (al igual que nosotros) no encuentran siempre un BIC}
